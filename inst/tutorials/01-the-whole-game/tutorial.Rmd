...
Now, that we've documented our function, we have access to a help page for it! Visit it by typing `?strsplit1` in the Console and CP/CR. If this doesn't work, run `load_all()` in the Console again. 
...
You should see a new `.R` file called `test-strsplit1`. If it had already existed, `use_test()` would have just opened it.
...
Let’s imagine you decide you’d rather build **regexcite** based on **stringr** than base R’s regular expression functions.
