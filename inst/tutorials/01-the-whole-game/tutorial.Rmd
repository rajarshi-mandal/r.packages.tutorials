...
<!-- The RStudio and Github tutorial is the best guide of our current practices. Do it (and submit a PR with lots of fixes) before starting this. Key is to always make students prove that they have completed each step, and help them to know that everything is OK.  -->

<!-- The Quarto Websites tutorial is similar. Do it (and submit a PR with lots of fixes) before starting this. I am not sure if those two follow the same practices when it comes to creating Github repos, restarting the RStudio session and so on. You should figure out the best practices and have all three tutorials use the same approach. -->
